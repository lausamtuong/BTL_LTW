...
const News = () => {
  ...
  const api= [
    {
      url:"",
      name: "Hơn 5.000 đăng ký tham gia cuộc thi toàn cầu của Vietvà Nas Academy",
    ...
    },
    {
      ...
      name: "Vietcông bố kết quả kinh doanh ô tô Tháng 2/2022",
    ...
    },
    {
      ...
      name: "Viettham dự triển lãm di động toàn cầu MWC 2022",
    ...
    },
    {
      ...
      name: "Vietthay đổi lựa chọn màu sơn ngoại thất đón đầu xu hướng",
    ...
    },
    {
      ...
      name: "Trải nghiệm không gian hiện đại, đẳng cấp tại VietNguyễn Văn Linh",
    ...
    },
    {
      ...
      name: "Vietvà Nas Academy tổ chức cuộc thi toàn cầu truyền cảm hứng chuyển đổi từ xe xăng sang xe điện",
    ...
    },
    {
      ...
      name: "Vietra mắt xe máy điện Vento hoàn toàn mới, tốc độ tối đa 80km/h",
    ...
    },
    {
      ...
      name: "Khám phá trải nghiệm xuất sắc chỉ có trên “ghế cơ trưởng” của VietVF 9",
    ...
    },
    {
      ...
      name: "Vietcông bố kết quả kinh doanh ô tô Tháng 1/2022",
    ...
    },
    {
      ...
      name: "Khám phá kho giải trí đa dạng nội dung trong ứng dụng FPT Play trên VietVF e34",
    ...
    },
    {
      ...
      name: "Vietthông báo chính sách cho thuê pin ô tô và chính sách sạc tại trạm sạc công cộng 2022",
    ...
    },
    {
      ...
      name: "Lưu ý và hướng dẫn sử dụng bộ sạc di động 2.2 kW cho xe điện VietVF e34",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/thanh-toan-tra-gop-0-tien-loi-qua-payoo-khi-mua-xe-may-dien-vinfast",
      name: "Vietnâng cao bảo hành lên 10 năm cho các dòng Ô tô chạy xăng",
      img: "https://storage.googleapis.com/vinfast-data-01/styles/news_360x200/public/2022_01/OSxOF_1641963570.jpg?itok=ltbUXn52",
    },
    {
      url:"https://vinfastauto.com/vn_vi/thanh-toan-tra-gop-0-tien-loi-qua-payoo-khi-mua-xe-may-dien-vinfast",
      name: "Vietbán ra tổng cộng 35.723 xe ô tô trong năm 2021",
    ...
    },
    {
      ...
      name: "Viettriển khai dịch vụ sửa chữa lưu động chính hãng đầu tiên tại Việt Nam",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/ngap-tran-uu-dai-khi-mua-xe-vinfast-trong-thang-10",
      name: "Vietcam kết phục vụ đến hết vòng đời với từng chiếc xe bán ra",
    ...
    },
    {
      ...
      name: "Vietcông bố chiến lược thuần điện và dải sản phẩm hoàn thiện tại CES 2022",
    ...
    },
    {
      ...
      name: "Vietcông bố nhận đặt hàng trước xe VF e35, VF e36 và ứng dụng blockchain tại CES",
    ...
    },
    {
      ...
      name: "Vingroup bổ nhiệm bà Lê Thị Thu Thủy làm Tổng giám đốc Viettoàn cầu thay ông Michael Lohscheller",
    ...
    },
    {
      ...
      name: "Vietbàn giao lô xe ô tô điện VF e34 đầu tiên cho Khách hàng",
    ...
    },
    {
      ...
      name: "Vietgiới thiệu dải sản phẩm ô tô điện và các công nghệ thông minh tại triển lãm CES 2022",
    ...
    },
    {
      ...
      name: "Vietcông bố kết quả kinh doanh ô tô tháng 11/2021",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/thong-bao-chinh-sach-ban-hang-o-to-thang-052022",
      name: "Vietsẽ bàn giao lô xe ô tô điện VF e34 đầu tiên vào ngày 25/12/2021",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/mua-xe-may-dien-vinfast-don-xuan-nham-dan-nhan-ngay-li-xi-hap-dan-tu-easy-credit",
      name: "Viettập trung triển khai dịch vụ đổi pin cho xe máy điện tại hệ thống Xưởng Dịch vụ và Showroom Vin3S trên toàn quốc",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/mua-xe-may-dien-vinfast-don-xuan-nham-dan-nhan-ngay-li-xi-hap-dan-tu-easy-credit",
      name: "Vietchính thức khai trương Showroom Viet3S Hải Phòng",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/tet-vui-gop-xe-lai-suat-cuc-me-chi-099",
      name: "Vietra mắt thương hiệu xe điện tại Los Angeles Auto Show 2021",
      img: "https://vinfastauto.com/sites/default/files/styles/news_360x200/public/2021-11/VF1_1637230117.jpg?itok=5YPxeRyV",
    },
    {
      url:"https://vinfastauto.com/vn_vi/tra-gop-de-dang-ron-rang-don-xe-yeu-cung-vinfast",
      name: "Vietxuất khẩu lô xe đầu tiên sang thị trường Lào",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/ngap-tran-uu-dai-khi-mua-xe-vinfast-trong-thang-10",
      name: "Vietcông bố kết quả kinh doanh ô tô Tháng 10/2021",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/ngap-tran-uu-dai-khi-mua-xe-vinfast-don-tet-2022",
      name: "Vietvà EDF ký kết biên bản ghi nhớ hợp tác lắp đặt trạm sạc điện tại Pháp",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/thong-bao-chinh-sach-ban-hang-o-to-thang-052022",
      name: "Vietcông bố 2 mẫu xe điện mới tại Los Angeles Auto Show 2021",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/bat-tron-co-hoi-so-huu-xe-sang-vinfast-cung-loat-uu-dai-khung-thang-7",
      name: "Vietcông bố kết quả kinh doanh ô tô tháng 9/2021",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/bat-tron-co-hoi-so-huu-xe-sang-vinfast-cung-loat-uu-dai-khung-thang-7",
      name: "Viethợp tác với tổ chức xe hơi hàng đầu Châu Âu - AUTOBEST thúc đẩy xu hướng ô tô điện",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/vui-don-he-voi-vinfast-lux-a20-tang-voucher-nghi-duong-vinpearl",
      name: "Vietchọn Cerence làm đối tác phát triển trợ lý ảo thông minh điều khiển bằng giọng nói",
      img: "https://storage.googleapis.com/vinfast-data-01/styles/news_360x200/public/2021_09/VFe36_1632812116.jpg?itok=KugEFGq_",
    },
    {
      url:"https://vinfastauto.com/vn_vi/tet-vui-gop-xe-lai-suat-cuc-me-chi-099",
      name: "Vietcông bố kết quả kinh doanh ô tô tháng 08/2021",
    ...
    },
    {
      ...
      name: "Vietra mắt app VietE-Scooter mới dành riêng cho các dòng xe máy điện",
      img: "https://storage.googleapis.com/vinfast-data-01/styles/news_360x200/public/2021_09/sieuapp_1631701003.png?itok=qG2fSPpO",
    },
    {
      url:"https://vinfastauto.com/vn_vi/news-VFe34",
      name: "Viettìm kiếm đối tác đặt trạm xe điện toàn quốc",
    ...
    {
      url:"https://vinfastauto.com/vn_vi/ngap-tran-uu-dai-khi-mua-xe-vinfast-trong-thang-10",
      name: "Viethợp tác với Gotion High-Tech nghiên cứu và sản xuất cell pin LFP cho xe điện",
