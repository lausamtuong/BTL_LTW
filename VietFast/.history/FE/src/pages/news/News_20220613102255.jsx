    ...
    <div className="news">
      ...
      {addNew ? (
        <div class="craete-post">
          ...
          <div className="btns">
            <button className="btn-post">Hoàn tất</button>
            <button className="btn-post">Hủy bỏ</button>
          </div>
        </div>
      ) : (
        ""
    ...
    <div className="card_content">
      ...
      {props.admin == "true" ? (
        <div className="button-edit">
          <span>Sửa</span>
          <span onClick={(e)=>console.log(e.target.parentNode.parentNode.classList.add)}>Xóa</span>
        </div>
      ) : (
        ""
      )}
