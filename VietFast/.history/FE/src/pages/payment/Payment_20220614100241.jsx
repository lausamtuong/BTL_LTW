      ...
      <div className="payment__customer">
        ...
        <div className="voucher">
          ...
          <div className="input">
            ...
            <button
              ...
              onClick={() => {
                const discount =   Number(item[0].price.split(" ")[0].replaceAll(".", "")) * 0.9;
                alert(  Number(item[0].price.split(" ")[0].replaceAll(".", "")));
              }}
            >
              ÁP DỤNG
            </button>
        ...
        <div className="thanhtoan">
          ...
          <span>
            ...
            {item[0].price} cho VietnFast bằng cách lựa chọn một trong các
