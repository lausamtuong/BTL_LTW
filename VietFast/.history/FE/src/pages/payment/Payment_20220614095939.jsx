      ...
      <div className="payment__customer">
        ...
        <div className="voucher">
          ...
          <div className="input">
            ...
            <button type="button" className="btn btn__voucher" onClick={()=>{const discount  = item[0].price*0.9}
               aler(discount)}>
              ÁP DỤNG
            </button>
          </div>
        ...
        <div className="thanhtoan">
          ...
          <span>
            ...
            {item[0].price} cho VietnFast bằng cách lựa chọn một trong các phương
            thức thanh toán sau:
          </span>
