          ...
          <>
            ...
            <div
              ...
              onClick={() => {
                let newList = [...list];
                console.log(newList)
                const i = list?.map((items,index) => {
                if(items?.params == item?.params ){
                ...
                const total = i.reduce((accumulator, item) => accumulator + item)
               
                let itemx = {...newList[total]};  
                itemx.price = newPrice;
                newList[total] = itemx;
