...
import { getComment, senCommentToDB,deleteCommentToDB } from "../../reduxToolkit/apiRequest";
const Detail = () => {
  ...
  const deleteComment = (item)=>{
   ...
   setComment(comment.filter(state=> state.time!=item.time));
   deleteCommentToDB(data, dispatch);
  }
      ...
      <div className="detail__header">
        <div className="text">
          ...
          <div className="text--highlight">
            <div className="__label">VIETNFAST {item[0].name.split(" ")[0]}</div>
        ...
        <div
          className="buy__box"
          onClick={() => {
            if (user) navigate(`../product/payment/${item[0].params}`);
            else {
              navigate(`/login`);
      ...
      <div className="detail__comment">
        <div className="comment-head">
          <div className="comment-head-avt">
            <img src={user?.image?user?.image:avt} alt="avt" />
          </div>
      ...
      <div className="render__comment">
        {
          ...
          <div className="render-box" key={index}>
            <div className="comment-main">
              <div className="comment-head-avt">
                <img src={item.image?item.image:avt} alt="avt" />
              </div>
            ...
            <div className="comment-handle">
              ...
              {user?.isAdmin?(<div className='comment-delete'  onClick={()=>deleteComment(item)}>
                Xóa
              </div>):''}
